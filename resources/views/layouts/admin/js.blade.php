...
<script src="{{URL::to('assets2/plugins/vectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
<script src="{{URL::to('assets2/plugins/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<script src="{{URL::to('assets2/plugins/chartjs/js/Chart.min.js')}}"></script>
